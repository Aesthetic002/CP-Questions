## Problem Link [Here](https://leetcode.com/problems/unique-length-3-palindromic-subsequences/description/?envType=daily-question&envId=2025-11-21)

### Related Problems

### Topics [[Prefix Sum]] [[Maps]] [[Sets]] [[Strings]]
...
![example](https://leetcode.com/problems/unique-length-3-palindromic-subsequences/Figures/1930/1.png)  
...
            for(int k=i.second[0]+1;k<i.second.back();k++){
